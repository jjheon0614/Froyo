...
//            for (Post post : allPosts) {
//                if (post.getContent().toLowerCase().contains(searchText.toLowerCase()) && ((post.getDate().compareTo(dateFrom) >= 0) && (post.getDate().compareTo(dateTo) <= 0))) {
//                    filteredPosts.add(post);
//                }
//            }
//        }
...
//            for (Post post : allPosts) {
//                if ((post.getDate().compareTo(dateFrom) >= 0) && (post.getDate().compareTo(dateTo) <= 0)) {
//                    filteredPosts.add(post);
//                }
//            }
//        }
